...
public class DecoreazaController {
    ...
    @RequestMapping(value = "/decoreaza/update/{id_act_vechi}/{id_recuzita_vechi}", method = RequestMethod.POST)
    public String update(@ModelAttribute("Decoreaza") Decoreaza decor, @PathVariable(name = "id_act_vechi") int id_act_vechi, @PathVariable(name = "id_recuzita_vechi") int id_recuzita_vechi) {
        dao.update(decor, id_act_vechi, id_recuzita_vechi);
