...
public class Melodie_OrchestrantController {
    ...
    @RequestMapping(value = "/melodie_orchestrant/update/{id_melodie_vechi}/{id_orchestrant_vechi}", method = RequestMethod.POST)
    public String update(@ModelAttribute("Melodie_Orchestrant") Melodie_Orchestrant mel_om, @PathVariable(name = "id_melodie_vechi") int id_melodie_vechi, @PathVariable(name = "id_orchestrant_vechi") int id_orchestrant_vechi) {
        dao.update(mel_om, id_melodie_vechi, id_orchestrant_vechi);
