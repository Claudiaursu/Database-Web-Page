...
public class Melodie_OrchestrantDAO {
    ...
    public void update(Melodie_Orchestrant mel_om, int id_melodie_vechi, int id_orchestrant_vechi) {
        String sql = "UPDATE MELODIE_ORCHESTRANT SET id_melodie=:id_melodie, id_orchestrant=:id_orchestrant WHERE id_melodie=" + id_melodie_vechi + " and id_orchestrant=" + id_orchestrant_vechi;
        BeanPropertySqlParameterSource param = new BeanPropertySqlParameterSource(mel_om);
