...
public class DecoreazaDAO {
    ...
    public void update(Decoreaza decor, int id_act_vechi, int id_recuzita_vechi) {
        String sql = "UPDATE DECOREAZA SET id_act=:id_act, id_recuzita=:id_recuzita WHERE id_act=" + id_act_vechi + " and id_recuzita=" + id_recuzita_vechi;
        BeanPropertySqlParameterSource param = new BeanPropertySqlParameterSource(decor);
